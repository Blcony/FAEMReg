...
mean = 144.603
stddev = 33.378
eval_dir = '/userhome/Data/CremiA_1180/expand/warp/test_1'
base_dir = '/userhome/EM_registration/RegisNet/Result_test_62'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num", type=int, dest="num", default=61, help="Number of examples to evaluate")
