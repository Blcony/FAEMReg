...
if __name__ == '__main__':
    ...
    Flow_path = '/userhome/EM_registration/RegisNet/Result_FIB/' + args.model + '/output_' + args.ckpt_iter

    Warped_image_path = check_path(
        '/userhome/EM_registration/RegisNet/Result_FIB/' + args.model + '/image_warped_' + args.ckpt_iter)
