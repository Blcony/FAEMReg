...
if __name__ == '__main__':
    ...
    Flow_path = '/userhome/EM_registration/RegisNet/Result_test/' + args.model + '/output_' + args.ckpt_iter

    Label_path = '/userhome/Data/CremiA_1180/expand/warp/test_1_label'

    Warped_label_path = check_path(
        '/userhome/EM_registration/RegisNet/Result_test/' + args.model + '/label_warped_' + args.ckpt_iter)

    Warped_image_path = check_path(
        '/userhome/EM_registration/RegisNet/Result_test/' + args.model + '/image_warped_' + args.ckpt_iter)
