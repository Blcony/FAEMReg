...
if __name__ == '__main__':
    ...
    Warped_label_path = '/userhome/EM_registration/RegisNet/Result/' + args.model + '/label_warped_' + args.ckpt_iter + '.tif'

    Dice_greedy('/userhome/Data/CremiA_1180/expand/raw/valid/valid_label_expand_padded.tif',
                Warped_label_path,
                weighted=False)
